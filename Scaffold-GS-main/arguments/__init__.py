...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.enable_temporal_lora = False
        self.num_time_steps = 1
        self.time_step = 0
        self.time_source_paths = ""
        self.temporal_latent_dim = 6
        self.freeze_anchor_topology_after_base = True
        self.enable_color_lora = True
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.base_iterations = 30_000
        self.adapt_iterations = 30_000
        ...
        self.mlp_temporal_bank_lr_init = 0.01
        self.mlp_temporal_bank_lr_final = 0.00001
        self.mlp_temporal_bank_lr_delay_mult = 0.01
        self.mlp_temporal_bank_lr_max_steps = 30_000
        ...
        self.bank_lora_lr = 0.0005
        self.opacity_lora_lr = 0.0005
        self.cov_lora_lr = 0.0002
        self.color_lora_lr = 0.001
        self.lambda_latent = 1e-4
        self.lambda_lora = 1e-5
