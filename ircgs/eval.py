...
from ircgs.models.irc_gs import _load_scaffold_mlp_payload
...
from ircgs.utils.loss_utils import l1_loss, ssim
...
def _resolve_4dgs_root(checkpoint: Dict[str, Any], model_cfg: Dict[str, Any]) -> Path:
    ...
    raise FileNotFoundError(
        ...
        "4DGS checkpoint config, or place 4DGaussians-master next to ircgs."
    )
