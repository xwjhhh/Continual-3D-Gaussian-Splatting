...
from ircgs.dataset.colmap_reader import read_intrinsics_binary, read_extrinsics_binary, qvec2rotmat, read_intrinsics_text, read_extrinsics_text
...
from ircgs.change_detection.dinov2_detector import DinoV2Detector
...
from ircgs.pruning.sphere_pruner import SpherePruner
from ircgs.utils.loss_utils import combined_loss, l1_loss
from ircgs.history import HistoryRecorder, gaussian_params_from_model

# Try to import renderer
try:
    from ircgs.rendering.renderer import render
...
class CLSplatsTrainer:
    ...
    def _log_to_file_only(self, message: str) -> None:
        ...
        log_line = f"{timestamp} | INFO     | ircgs.models.cl_splats:train - {message}\n"
        try:
    ...
    def _render_from_cameras(self, cameras) -> List[torch.Tensor]:
        ...
        from ircgs.rendering import render
