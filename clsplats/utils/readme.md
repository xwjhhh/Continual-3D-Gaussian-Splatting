undistort_with_3dgs_convert.py去畸变：python clsplats/utils/undistort_with_3dgs_convert.py \
...
undistort_with_3dgs_convert.py去畸变：python clsplats/utils/undistort_with_3dgs_convert.py \
  ...
  --overwrite
  create_trian_test:划分训练集和测试集:python -m clsplats.utils.create_train_test_split \
...
sam+视频切分：python clsplats/utils/prepare_clsplats_object_masks.py \
...
单个图片切分：
python clsplats/utils/run_sam_on_folder.py \
